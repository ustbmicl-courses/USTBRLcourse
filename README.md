...
本仓库是北京科技大学计算机与通信工程学院“强化学习算法实践”课程的配套代码仓库，面向强化学习基础概念、经典动态规划方法、采样学习方法以及深度强化学习入门实践。

课程代码以“能运行、能改动、能复现实验现象”为目标，帮助学习者在阅读教材和课件之外，通过 Python 脚本与 Jupyter Notebook 观察算法行为，理解强化学习中的状态、动作、奖励、策略、价值函数、Bellman 方程、动态规划、Monte Carlo、TD 学习和函数逼近等核心内容。
